...
//  Description :   It returns the number of even elements in the linked list
//  Input :         PNODE
//  Output :        int
//  Author :        Nidhi Girish Kadival
//  Date :          31/12/2025
...
int main()
{
    ...
    iRet = CountEven(head);
    printf("Number of even elements in linked list are: %d\n",iRet);
...
//  No of nodes are: 6
//  Number of even elements in linked list are: 3
//
/////////////////////////////////////////////////////////////////////////////////////////////////