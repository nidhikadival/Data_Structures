...
//  Description :   It returns the number of a given element appears in the linked list
//  Input :         PNODE, int
//  Output :        int
//  Author :        Nidhi Girish Kadival
//  Date :          31/12/2025
...
int main()
{
    ...
    iRet = Frequency(head, no);
    printf("Frequency of %d in linked list is: %d\n",no,iRet);
...
//  10
//  Frequency of 10 in linked list is: 2
//
//  Enter number to find its frequency: 
//  30
//  Frequency of 30 in linked list is: 1
//
//  Enter number to find its frequency: 
//  99
//  Frequency of 99 in linked list is: 0
//
/////////////////////////////////////////////////////////////////////////////////////////////////