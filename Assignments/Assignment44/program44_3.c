...
//  Description :   It returns the number of odd elements in the linked list
//  Input :         PNODE
//  Output :        int
//  Author :        Nidhi Girish Kadival
//  Date :          31/12/2025
...
int main()
{
    ...
    iRet = CountOdd(head);
    printf("Number of odd elements in linked list are: %d\n",iRet);
...
//  | 10 | -> | 11 | -> | 21 | -> NULL
//  No of nodes are: 3
//  | 10 | -> | 11 | -> | 21 | -> | 30 | -> | 31 | -> | 51 | -> NULL
//  No of nodes are: 6
//  Number of odd elements in linked list are: 4
//
/////////////////////////////////////////////////////////////////////////////////////////////////