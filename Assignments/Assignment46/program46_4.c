...
//  Description :   It replaces the negative numbers to zero
//  Input :         PPNODE
//  Output :        void
//  Author :        Nidhi Girish Kadival
//  Date :          31/12/2025
...
int main()
{
    ...
    printf("After applying ReplaceNegative function:\n");
    Display(head);
...
//  No of nodes are: 6
//  After applying ReplaceNegative function:
//  | 0 | -> | 10 | -> | 11 | -> | 30 | -> | 0 | -> | 0 | -> NULL
//
/////////////////////////////////////////////////////////////////////////////////////////////////