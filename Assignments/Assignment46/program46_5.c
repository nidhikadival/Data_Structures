...
//  Description :   It increments all the elements by 1 
//  Input :         PPNODE
//  Output :        void
//  Author :        Nidhi Girish Kadival
//  Date :          31/12/2025
...
int main()
{
    ...
    printf("After applying IncrementAll function:\n");
    Display(head);
...
//  No of nodes are: 6
//  After applying IncrementAll function:
//  | -9 | -> | 11 | -> | 12 | -> | 31 | -> | -30 | -> | -50 | -> NULL
//
//  Output:
//  | 10 | -> | 10 | -> | 11 | -> NULL
//  No of nodes are: 3
