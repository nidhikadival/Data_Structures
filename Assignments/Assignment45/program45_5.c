...
//  Description :   It returns the count of the no of elements lesser than a particular number
//  Input :         PNODE, int
//  Output :        int
//  Author :        Nidhi Girish Kadival
//  Date :          31/12/2025
...
int main()
{
    ...
    iRet = CountLess(head, no);
    printf("Number of elements smaller than %d are %d\n",no,iRet);
...
//  Enter number: 
//  30
//  Number of elements smaller than 30 are 3
//  
//  Enter number: 
//  10
//  Number of elements smaller than 10 are 0
//
//  Enter number: 
//  31
//  Number of elements smaller than 31 are 4
//
/////////////////////////////////////////////////////////////////////////////////////////////////